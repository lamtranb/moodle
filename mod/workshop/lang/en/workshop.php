...
$string['privacy:metadata:preference:workshop_block_allexamples'] = 'The collapsed/expanded state currently applied to the Example submissions block.';
$string['privacy:metadata:preference:workshop_block_allsubmissions'] = 'The collapsed/expanded state currently applied to the Workshop submissions report block.';
$string['privacy:metadata:preference:workshop_block_assessmentform'] = 'The collapsed/expanded state currently applied to the Assessment form block.';
$string['privacy:metadata:preference:workshop_block_assignedassessments'] = 'The collapsed/expanded state currently applied to the Assigned submissions to assess block.';
$string['privacy:metadata:preference:workshop_block_cleargrades'] = 'The collapsed/expanded state currently applied to the Workshop toolbox block.';
$string['privacy:metadata:preference:workshop_block_conclusion'] = 'The collapsed/expanded state currently applied to the Conclusion block.';
$string['privacy:metadata:preference:workshop_block_examples'] = 'The collapsed/expanded state currently applied to the Example submissions to assess block.';
$string['privacy:metadata:preference:workshop_block_examplesfail'] = 'The collapsed/expanded state currently applied to the Example submissions to assess block.';
$string['privacy:metadata:preference:workshop_block_gradereport'] = 'The collapsed/expanded state currently applied to the Workshop grades report block.';
$string['privacy:metadata:preference:workshop_block_instructauthors'] = 'The collapsed/expanded state currently applied to the Instructions for submission block.';
$string['privacy:metadata:preference:workshop_block_instructreviewers'] = 'The collapsed/expanded state currently applied to the Instructions for assessment block.';
$string['privacy:metadata:preference:workshop_block_intro'] = 'The collapsed/expanded state currently applied to the Intro block.';
$string['privacy:metadata:preference:workshop_block_overallfeedback'] = 'The collapsed/expanded state currently applied to the Overall feedback block.';
$string['privacy:metadata:preference:workshop_block_ownsubmission'] = 'The collapsed/expanded state currently applied to the Your submission block.';
$string['privacy:metadata:preference:workshop_block_publicsubmissions'] = 'The collapsed/expanded state currently applied to the Published submissions block.';
$string['privacy:metadata:preference:workshop_block_yourgrades'] = 'The collapsed/expanded state currently applied to the Your grades block.';
$string['privacy:metadata:preference:workshop_perpage'] = 'Number of submissions the user prefers to see on one page';
