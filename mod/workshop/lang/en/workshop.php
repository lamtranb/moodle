...
$string['privacy:metadata:preference:viewlet'] = 'Records when the user collapsed/expanded a section in view page';
...
$string['privacy:request:viewlet:collapsed'] = 'Indicates whether the section in view page was collapsed';
...
$string['workshop:userprefname'] = '{$a->prefix}_{$a->prefname}_{$a->instanceid}';
